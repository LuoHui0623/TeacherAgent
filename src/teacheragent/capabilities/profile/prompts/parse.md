...
{
  "version": 2,
  "source": { "documentKey": "", "markdownVersionId": "", "contentHash": "", "parsedAt": "" },
...
其中 `source` 由调用方传入，原样回填，不要自行编造版本号或哈希。
...
{
  "version": 2,
  "source": { "documentKey": "default", "markdownVersionId": "admin-20260914120000", "contentHash": "sha256:9f2c", "parsedAt": "2026-09-14T12:00:00+08:00" },
  "overview": { "present": false, "text": "" },
  "sections": {
    "primaryTech": { "present": false, "text": "", "items": [] },
    "techStack": {
