...
const runtimeWorkflow: WorkflowDefinition = {
  ...
  edges: [
    ...
    { id: 'e4', from: { nodeId: 'merge', portId: 'blueprint' }, to: { nodeId: 'gate', portId: 'blueprint' } },
      ...
      outputs: [1, 2].map((index) =>
        artifactOutput(
          ...
          contentPipelineArtifactTypes.learningBrief,
          {
            ...
            scope: { level: 'intermediate', depth: 'deep', breadth: 'frontend', estimatedMinutes: 60 },
    ...
    return {
      outputs: [
          ...
          contentPipelineArtifactTypes.courseBlueprint,
        {
          ...
          expectedOutcomes: ['掌握性能优化'],
          coreKnowledgePointIds: ['performance'],
