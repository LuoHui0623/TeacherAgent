...
export const mainWorkflowDefinition: WorkflowDefinition = {
  ...
  nodes: [
    ...
    node({
      ...
      outputs: [
        port('validated', contentPipelineArtifactTypes.outline),
    ...
    node({
      ...
      inputs: [port('outline', contentPipelineArtifactTypes.outline)],
      outputs: [
        port('approved', contentPipelineArtifactTypes.outline),
        port('feedback', contentPipelineArtifactTypes.revisionFeedback, false, false),
      ],
      humanApproval: {
        scopeType: 'outline',
  ...
  edges: [
    ...
    edge('e-outline-validate', 'outline-architect', 'outline', 'outline-contract-gate', 'outline'),
    edge('e-outline-invalid', 'outline-contract-gate', 'invalid', 'outline-architect', 'feedback', '校验失败'),
    edge('e-outline-approval', 'outline-contract-gate', 'validated', 'outline-approval', 'outline'),
    edge('e-outline-revise', 'outline-approval', 'feedback', 'outline-architect', 'feedback', '要求修改'),
    edge('e-outline-write', 'outline-approval', 'approved', 'chapter-writers', 'outline', '审批通过'),
